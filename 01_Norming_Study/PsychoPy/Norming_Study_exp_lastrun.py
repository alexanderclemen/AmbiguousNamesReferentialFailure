...
expName = 'Norming_Study_exp'  # from the Builder filename that created this script
...
thisExp = data.ExperimentHandler(name=expName, version='',
    ...
    originPath='C:\\Users\\alexa\\Documents\\02_study\\duesseldorf\\BA_Linguistik\\09_BBA_Bachelorarbeit\\02_daten\\01_Norming_Study\\PsychoPy\\Norming_Study_exp_lastrun.py',
...
_key_resp_2_allKeys = []
# keep track of which components have finished
Intro3Components = [text_Intro3, key_resp_2]
