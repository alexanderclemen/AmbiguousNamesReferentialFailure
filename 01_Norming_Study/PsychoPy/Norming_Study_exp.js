...
function Intro1RoutineBegin(snapshot) {
  return async function () {
    ...
    for (const thisComponent of Intro1Components)
      if ('status' in thisComponent)
        thisComponent.status = PsychoJS.Status.NOT_STARTED;
    return Scheduler.Event.NEXT;
  }
...
function MuttersprachlerRoutineBegin(snapshot) {
  return async function () {
    ...
    for (const thisComponent of MuttersprachlerComponents)
      if ('status' in thisComponent)
        thisComponent.status = PsychoJS.Status.NOT_STARTED;
    return Scheduler.Event.NEXT;
  }
...
function trials_OtherNameLoopBegin(trials_OtherNameLoopScheduler, snapshot) {
  return async function() {
    ...
    for (const thisTrials_OtherName of trials_OtherName) {
...
function OtherNameRoutineBegin(snapshot) {
  return async function () {
    ...
    for (const thisComponent of OtherNameComponents)
      if ('status' in thisComponent)
        thisComponent.status = PsychoJS.Status.NOT_STARTED;
    return Scheduler.Event.NEXT;
  }
...
function biologicalSexRoutineBegin(snapshot) {
  return async function () {
    ...
    for (const thisComponent of biologicalSexComponents)
      if ('status' in thisComponent)
        thisComponent.status = PsychoJS.Status.NOT_STARTED;
    return Scheduler.Event.NEXT;
  }
...
function GenderIdentityRoutineBegin(snapshot) {
  return async function () {
    ...
    for (const thisComponent of GenderIdentityComponents)
      if ('status' in thisComponent)
        thisComponent.status = PsychoJS.Status.NOT_STARTED;
    return Scheduler.Event.NEXT;
  }
