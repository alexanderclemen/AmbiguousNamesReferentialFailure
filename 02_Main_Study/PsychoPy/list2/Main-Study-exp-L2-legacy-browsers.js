/************************** 
 * Main-Study-Exp-L2 Test *
 **************************/


// store info about the experiment session:
let expName = 'Main-Study-exp-L2';  // from the Builder filename that created this script
...
psychoJS.start({
  ...
  expInfo: expInfo,
  resources: [
    {'name': 'Main-Study-stimuli-L2-B5.xlsx', 'path': 'Main-Study-stimuli-L2-B5.xlsx'},
    {'name': 'Main-Study-stimuli-L2-B4.xlsx', 'path': 'Main-Study-stimuli-L2-B4.xlsx'},
    {'name': 'Main-Study-stimuli-L2-B3.xlsx', 'path': 'Main-Study-stimuli-L2-B3.xlsx'},
    {'name': 'Main-Study-stimuli-L2-B2.xlsx', 'path': 'Main-Study-stimuli-L2-B2.xlsx'},
    {'name': 'Main-Study-stimuli-L2-B6.xlsx', 'path': 'Main-Study-stimuli-L2-B6.xlsx'},
    {'name': 'Main-Study-stimuli-Examples.xlsx', 'path': 'Main-Study-stimuli-Examples.xlsx'},
    {'name': 'Main-Study-stimuli-L2-B1.xlsx', 'path': 'Main-Study-stimuli-L2-B1.xlsx'}
  ]
});
...
function Explaination_ScreenRoutineBegin(snapshot) {
  return async function () {
    ...
    Explaination_ScreenComponents.forEach( function(thisComponent) {
      if ('status' in thisComponent)
        thisComponent.status = PsychoJS.Status.NOT_STARTED;
       });
    return Scheduler.Event.NEXT;
...
function Explaination2_ScreenRoutineBegin(snapshot) {
  return async function () {
    ...
    Explaination2_ScreenComponents.forEach( function(thisComponent) {
      if ('status' in thisComponent)
        thisComponent.status = PsychoJS.Status.NOT_STARTED;
       });
    return Scheduler.Event.NEXT;
...
function trials00_LoopLoopBegin(trials00_LoopLoopScheduler, snapshot) {
  return async function() {
    ...
    trials00_Loop.forEach(function() {
...
function trials01_LoopLoopBegin(trials01_LoopLoopScheduler, snapshot) {
  return async function() {
    ...
    trials01_Loop = new TrialHandler({
      ...
      nReps: 1, method: TrialHandler.Method.SEQUENTIAL,
      extraInfo: expInfo, originPath: undefined,
      trialList: TrialHandler.importConditions(psychoJS.serverManager, 'Main-Study-stimuli-L2-B1.xlsx', '0:26'),
    ...
    // Schedule all the trials in the trialList:
    trials01_Loop.forEach(function() {
...
function trials02_LoopLoopBegin(trials02_LoopLoopScheduler, snapshot) {
  return async function() {
    ...
    trials02_Loop = new TrialHandler({
      ...
      nReps: 1, method: TrialHandler.Method.SEQUENTIAL,
      extraInfo: expInfo, originPath: undefined,
      trialList: TrialHandler.importConditions(psychoJS.serverManager, 'Main-Study-stimuli-L2-B2.xlsx', '0:21'),
    ...
    // Schedule all the trials in the trialList:
    trials02_Loop.forEach(function() {
...
function trials03_LoopLoopBegin(trials03_LoopLoopScheduler, snapshot) {
  return async function() {
    ...
    trials03_Loop = new TrialHandler({
      ...
      nReps: 1, method: TrialHandler.Method.SEQUENTIAL,
      extraInfo: expInfo, originPath: undefined,
      trialList: TrialHandler.importConditions(psychoJS.serverManager, 'Main-Study-stimuli-L2-B3.xlsx', '0:21'),
    ...
    // Schedule all the trials in the trialList:
    trials03_Loop.forEach(function() {
...
function trials04_LoopLoopBegin(trials04_LoopLoopScheduler, snapshot) {
  return async function() {
    ...
    trials04_Loop = new TrialHandler({
      ...
      nReps: 1, method: TrialHandler.Method.SEQUENTIAL,
      extraInfo: expInfo, originPath: undefined,
      trialList: TrialHandler.importConditions(psychoJS.serverManager, 'Main-Study-stimuli-L2-B4.xlsx', '0:21'),
    ...
    // Schedule all the trials in the trialList:
    trials04_Loop.forEach(function() {
...
function trials05_LoopLoopBegin(trials05_LoopLoopScheduler, snapshot) {
  return async function() {
    ...
    trials05_Loop = new TrialHandler({
      ...
      nReps: 1, method: TrialHandler.Method.SEQUENTIAL,
      extraInfo: expInfo, originPath: undefined,
      trialList: TrialHandler.importConditions(psychoJS.serverManager, 'Main-Study-stimuli-L2-B5.xlsx', '0:21'),
    ...
    // Schedule all the trials in the trialList:
    trials05_Loop.forEach(function() {
...
function trials06_LoopLoopBegin(trials06_LoopLoopScheduler, snapshot) {
  return async function() {
    ...
    trials06_Loop = new TrialHandler({
      ...
      nReps: 1, method: TrialHandler.Method.SEQUENTIAL,
      extraInfo: expInfo, originPath: undefined,
      trialList: TrialHandler.importConditions(psychoJS.serverManager, 'Main-Study-stimuli-L2-B6.xlsx', '0:21'),
    ...
    // Schedule all the trials in the trialList:
    trials06_Loop.forEach(function() {
...
function Pos01_NameRoutineBegin(snapshot) {
  return async function () {
    ...
    Pos01_NameComponents.forEach( function(thisComponent) {
      if ('status' in thisComponent)
        thisComponent.status = PsychoJS.Status.NOT_STARTED;
       });
    return Scheduler.Event.NEXT;
...
function Pos02_VRoutineBegin(snapshot) {
  return async function () {
    ...
    Pos02_VComponents.forEach( function(thisComponent) {
      if ('status' in thisComponent)
        thisComponent.status = PsychoJS.Status.NOT_STARTED;
       });
    return Scheduler.Event.NEXT;
...
function Pos03_PPRoutineBegin(snapshot) {
  return async function () {
    ...
    Pos03_PPComponents.forEach( function(thisComponent) {
      if ('status' in thisComponent)
        thisComponent.status = PsychoJS.Status.NOT_STARTED;
       });
    return Scheduler.Event.NEXT;
...
function Pos04_PRORoutineBegin(snapshot) {
  return async function () {
    ...
    Pos04_PROComponents.forEach( function(thisComponent) {
      if ('status' in thisComponent)
        thisComponent.status = PsychoJS.Status.NOT_STARTED;
       });
    return Scheduler.Event.NEXT;
...
function Pos05_3RoutineBegin(snapshot) {
  return async function () {
    ...
    Pos05_3Components.forEach( function(thisComponent) {
      if ('status' in thisComponent)
        thisComponent.status = PsychoJS.Status.NOT_STARTED;
       });
    return Scheduler.Event.NEXT;
...
function Pos06_2RoutineBegin(snapshot) {
  return async function () {
    ...
    Pos06_2Components.forEach( function(thisComponent) {
      if ('status' in thisComponent)
        thisComponent.status = PsychoJS.Status.NOT_STARTED;
       });
    return Scheduler.Event.NEXT;
...
function Pos07_2RoutineBegin(snapshot) {
  return async function () {
    ...
    Pos07_2Components.forEach( function(thisComponent) {
      if ('status' in thisComponent)
        thisComponent.status = PsychoJS.Status.NOT_STARTED;
       });
    return Scheduler.Event.NEXT;
...
function Pos08_2RoutineBegin(snapshot) {
  return async function () {
    ...
    Pos08_2Components.forEach( function(thisComponent) {
      if ('status' in thisComponent)
        thisComponent.status = PsychoJS.Status.NOT_STARTED;
       });
    return Scheduler.Event.NEXT;
...
function Pos09_2RoutineBegin(snapshot) {
  return async function () {
    ...
    Pos09_2Components.forEach( function(thisComponent) {
      if ('status' in thisComponent)
        thisComponent.status = PsychoJS.Status.NOT_STARTED;
       });
    return Scheduler.Event.NEXT;
...
function Comp_qRoutineBegin(snapshot) {
  return async function () {
    ...
    Comp_qComponents.forEach( function(thisComponent) {
      if ('status' in thisComponent)
        thisComponent.status = PsychoJS.Status.NOT_STARTED;
       });
    return Scheduler.Event.NEXT;
...
function Comp_respRoutineBegin(snapshot) {
  return async function () {
    ...
    Comp_respComponents.forEach( function(thisComponent) {
      if ('status' in thisComponent)
        thisComponent.status = PsychoJS.Status.NOT_STARTED;
       });
    return Scheduler.Event.NEXT;
...
function Explaination_Screen3RoutineBegin(snapshot) {
  return async function () {
    ...
    Explaination_Screen3Components.forEach( function(thisComponent) {
      if ('status' in thisComponent)
        thisComponent.status = PsychoJS.Status.NOT_STARTED;
       });
    return Scheduler.Event.NEXT;
