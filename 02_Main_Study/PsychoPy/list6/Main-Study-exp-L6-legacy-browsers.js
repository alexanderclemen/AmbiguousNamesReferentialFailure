/************************** 
 * Main-Study-Exp-L6 Test *
 **************************/


// store info about the experiment session:
let expName = 'Main-Study-exp-L6';  // from the Builder filename that created this script
...
psychoJS.start({
  ...
  expInfo: expInfo,
  resources: [
    {'name': 'Main-Study-stimuli-L6-B4.xlsx', 'path': 'Main-Study-stimuli-L6-B4.xlsx'},
    {'name': 'Main-Study-stimuli-L6-B3.xlsx', 'path': 'Main-Study-stimuli-L6-B3.xlsx'},
    {'name': 'Main-Study-stimuli-L6-B6.xlsx', 'path': 'Main-Study-stimuli-L6-B6.xlsx'},
    {'name': 'Main-Study-stimuli-L6-B1.xlsx', 'path': 'Main-Study-stimuli-L6-B1.xlsx'},
    {'name': 'Main-Study-stimuli-L6-B2.xlsx', 'path': 'Main-Study-stimuli-L6-B2.xlsx'},
    {'name': 'Main-Study-stimuli-L6-B5.xlsx', 'path': 'Main-Study-stimuli-L6-B5.xlsx'},
...
function trials01_LoopLoopBegin(trials01_LoopLoopScheduler, snapshot) {
  return async function() {
    ...
    trials01_Loop = new TrialHandler({
      ...
      nReps: 1, method: TrialHandler.Method.SEQUENTIAL,
      extraInfo: expInfo, originPath: undefined,
      trialList: TrialHandler.importConditions(psychoJS.serverManager, 'Main-Study-stimuli-L6-B1.xlsx', '0:26'),
...
function trials02_LoopLoopBegin(trials02_LoopLoopScheduler, snapshot) {
  return async function() {
    ...
    trials02_Loop = new TrialHandler({
      ...
      nReps: 1, method: TrialHandler.Method.SEQUENTIAL,
      extraInfo: expInfo, originPath: undefined,
      trialList: TrialHandler.importConditions(psychoJS.serverManager, 'Main-Study-stimuli-L6-B2.xlsx', '0:21'),
...
function trials03_LoopLoopBegin(trials03_LoopLoopScheduler, snapshot) {
  return async function() {
    ...
    trials03_Loop = new TrialHandler({
      ...
      nReps: 1, method: TrialHandler.Method.SEQUENTIAL,
      extraInfo: expInfo, originPath: undefined,
      trialList: TrialHandler.importConditions(psychoJS.serverManager, 'Main-Study-stimuli-L6-B3.xlsx', '0:21'),
...
function trials04_LoopLoopBegin(trials04_LoopLoopScheduler, snapshot) {
  return async function() {
    ...
    trials04_Loop = new TrialHandler({
      ...
      nReps: 1, method: TrialHandler.Method.SEQUENTIAL,
      extraInfo: expInfo, originPath: undefined,
      trialList: TrialHandler.importConditions(psychoJS.serverManager, 'Main-Study-stimuli-L6-B4.xlsx', '0:21'),
...
function trials05_LoopLoopBegin(trials05_LoopLoopScheduler, snapshot) {
  return async function() {
    ...
    trials05_Loop = new TrialHandler({
      ...
      nReps: 1, method: TrialHandler.Method.SEQUENTIAL,
      extraInfo: expInfo, originPath: undefined,
      trialList: TrialHandler.importConditions(psychoJS.serverManager, 'Main-Study-stimuli-L6-B5.xlsx', '0:21'),
...
function trials06_LoopLoopBegin(trials06_LoopLoopScheduler, snapshot) {
  return async function() {
    ...
    trials06_Loop = new TrialHandler({
      ...
      nReps: 1, method: TrialHandler.Method.SEQUENTIAL,
      extraInfo: expInfo, originPath: undefined,
      trialList: TrialHandler.importConditions(psychoJS.serverManager, 'Main-Study-stimuli-L6-B6.xlsx', '0:21'),
